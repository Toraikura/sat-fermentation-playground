(() => {
  ...
  const ROWS = [
    ...
    ['4vg','4-ビニルグアイアコール','4-Vinylguaiacol','PHENOL','燻製・香辛料 / クローブ',['aroma-smoked','aroma-clove']],
    ...
    ['4eg','4-エチルグアヤコール','4-Ethylguaiacol / 4EG','PHENOL','スモーキー・スパイス',['aroma-smoked','aroma-spice']],
    ...
    ['guaiacol','グアヤコール','Guaiacol','PHENOL','煙・フェノール',['aroma-smoke','aroma-phenol']],
